...
class Save extends \Ism\Events\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('ism/events');
                        ...
                        $imagePath = 'ism/events'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('ism_events/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('ism_events/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('ism_events/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('ism_events/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('ism_events/*/');
