<?php
namespace ISM\DeliveryDate\Model;
...
class Config
{
    const XPATH_FORMAT                 = 'ism_deliverydate/general/format';
    const XPATH_DISABLED               = 'ism_deliverydate/general/disabled';
    const XPATH_HOURMIN                = 'ism_deliverydate/general/hourMin';
    const XPATH_HOURMAX                = 'ism_deliverydate/general/hourMax';
    const XPATH_REQUIRED_DELIVERY_DATE = 'ism_deliverydate/general/required_delivery_date';
